        ...
        function decompileToBlocksAsync(code, options) {
            ...
            return loadPackageAsync(packageid, code)
                ...
                return ts.pxtc.localizeApisAsync(apis, runner.mainPkg)
                    ...
                    var useNewFunctions = pxt.appTarget.runtime && pxt.appTarget.runtime.functionsOptions && pxt.appTarget.runtime.functionsOptions.useNewFunctions;
                    var bresp = pxtc.decompiler.decompileToBlocks(blocksInfo, program.getSourceFile("main.ts"), { snippetMode: options && options.snippetMode, useNewFunctions: useNewFunctions });
