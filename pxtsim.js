...
(function (pxsim) {
    ...
    function dumpHeap(v, heap) {
        ...
        function frameVars(frame) {
            ...
            if (frame.fields) {
                // Fields of an object.
                for (var _b = 0, _c = Object.keys(frame.fields); _b < _c.length; _b++) {
                    var k = _c[_b];
...
(function (pxsim) {
    ...
    (function (SimulatorState) {
        ...
        SimulatorState[SimulatorState["Starting"] = 2] = "Starting";
        SimulatorState[SimulatorState["Running"] = 3] = "Running";
        SimulatorState[SimulatorState["Paused"] = 4] = "Paused";
        SimulatorState[SimulatorState["Suspended"] = 5] = "Suspended";
